...
insmod part_gpt
insmod ext2
linux   (lvm/vos--root-init)/a/vmlinuz-%s root=%s quiet splash bgrt_disable $vt_handoff
initrd  (lvm/vos--root-init)/a/initrd.img-%s
"""
...
menuentry "ABRoot A (current)" --class abroot-a {
    ...
    configfile "/.system/boot/init/a/abroot.cfg"
}

menuentry "ABRoot B (previous)" --class abroot-b {
    set root=(lvm/vos--root-init)
    configfile "/.system/boot/init/b/abroot.cfg"
}
            ...
            recipe.add_postinstall_step(
                ...
                [
                    " ".join(
                        ...
                        envsubst < /tmp/abroot.cfg > /mnt/a/.system/boot/init/a/abroot.cfg \
